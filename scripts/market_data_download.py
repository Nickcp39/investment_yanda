...
YAHOO = {
    ...
    "MSFT":      ("MSFT",     "mega_cap",     "Microsoft Corp. (adj close)", "USD"),
    "GOOG":      ("GOOG",     "mega_cap",     "Alphabet Inc. Class C (adj close)", "USD"),
    "GOOGL":     ("GOOGL",    "mega_cap",     "Alphabet Inc. Class A (adj close)", "USD"),
    "AAPL":      ("AAPL",     "mega_cap",     "Apple Inc. (adj close)", "USD"),
    "NVDA":      ("NVDA",     "mega_cap",     "NVIDIA Corp. (adj close)", "USD"),
    "AMZN":      ("AMZN",     "mega_cap",     "Amazon.com Inc. (adj close)", "USD"),
    "META":      ("META",     "mega_cap",     "Meta Platforms Inc. (adj close)", "USD"),
    "TSLA":      ("TSLA",     "mega_cap",     "Tesla Inc. (adj close)", "USD"),
