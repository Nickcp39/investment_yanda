...
### 5b. 市场价格（LIVE 数据，as_of 2026-06-19）— 三源交叉验证
- **as_of price = $368.03**（2026-06-18 收盘，最后一个 ≤ as_of 2026-06-19 的日收盘）。三源一致：Yahoo chart API + stockanalysis.com + WebSearch，delta 0.0%，过 `verify_freshness.py`。[S-YHOO / freshness.json]
- 市值 ≈ **$4.459T**（12,116M 稀释股 × $368.03）；stockanalysis 报 ~$4.49T（差 0.7%）。
- **52 周区间 $162.00 – $408.61**（ATH 收盘 $402.38，2026-05-13）。现价**距 52 周高 −9.9%、距 52 周低 +127%** → 位于区间上部，**不是 52 周低点**（与 NVDA INC-001"误抓 52 周低当现价"的失败模式相反；本 dossier 价格正确）。[stockanalysis / websearch / freshness.json]
- 备用锚：Berkshire 2026-06 私募 A $351.81 / C $348.20（与市价仅差 ~5%，互为验证）。[GOOGL-424B5-2026-06]
...
### 9. 法律与监管
**FILED 快照（FY2025 10-K，口径正确，保留）:**
- EC adtech "self-preferencing" 罚款，Q3 2025 计提 **$3.5B**（已上诉），驱动 G&A 同比增约 $6.2B；年末短期计提的罚款/和解 $15.6B。[GOOG.A1.2025K.026]（注：罚款金额 10-K 内记为 ~€3.0B 级；EC 正式决定金额见下方 LIVE 更新）
- DOJ adtech 案 2025-04 部分败诉，结构性救济提案"could have a material adverse effect"，最终判决待定。[GOOG.A1.2025K.026 notes]

**LIVE 更新（2026-06，三案均已推进，原 10-K 框架已过时 — 见 `freshness.json` active_litigation）:**
- **DOJ 搜索案（Mehta 法官，DDC）**: 救济已于 **2025-09-02 终裁——Google 保留 Chrome 与 Android**（法院**驳回**了 DOJ 的结构性分拆请求），救济为**行为性**（禁止 Search/Chrome/Assistant/Gemini 的独家默认分发合同 + 须向合格对手共享搜索索引与用户交互数据）。Google 2026-01-16 上诉、DOJ 2026-02-03 交叉上诉求分拆、Google 2026-05-22 向 DC 巡回法院递交开庭主张；口头辩论预期 2026 末/2027 初，终局或迟至 2028。**净效果：体量更大的搜索案未导致分拆，比"结构性救济"显著更轻，而原 dossier 从未记录此结果。** [DOJ OPA 2025-09-02 / techtimes 2026-06-20]
- **DOJ adtech 案（Brinkema 法官，EDVA）**: 2025-04 认定违法（publisher ad server + ad exchange 垄断）。**救济庭审现已结束**（结案陈词已完成）；DOJ 求分拆 AdX（再及 DFP）+ 开源拍卖逻辑，但 **Brinkema 法官对结构性救济表示怀疑**、并担忧分拆时效 vs 行为性救济。**裁决待出**（截至 2026-06 无判令）。原 dossier"结构性救济待定"方向对，但低估了"现已进入庭审后、法官偏向不分拆"这一进展。[adexchanger 2026-05 / courthousenews]
- **EC adtech 罚款**: EC **正式决定 2025-09-05 落地 = €2.95B（约 $3.45B）** + 责令停止 adtech 自我优待（第 4 次欧盟处罚）；Google 上诉中。FY2025 P&L 内 ~$3.5B 计提即为此项 accrual，FILED 数仍正确。[cnbc 2025-09-05]
