...
**Where is profit captured?** VRT captures durable profit at the **integration/system layer** — owning the validated NVIDIA reference design + speed-to-deploy + breadth + services — *above* a commoditizing component layer (cold plates/CDUs) and *below* a concentrated, powerful set of hyperscaler buyers. It **owns the integration bottleneck and supplies into the component bottleneck** (C033). The ThermoKey close (C034) pushes VRT slightly further *up* the thermal supply chain (heat-rejection / dry coolers), bringing more of the thermal BoM in-house. The structural caveat is unchanged: it captures system-layer profit but rides four customers' discretionary capex with no contracted floor.
...
| Force | Strength | Note |
|---|---|---|
| Supplier power (component OEMs) | **Low–Medium** | cold-plate/CDU multi-sourced; inside VRT's BoM (ThermoKey brings more in-house) |
