...
**状态**: `✅ 7/7 完成且全 CLEAN(DECISION_DRAFT 级)。唯 NVDA/MSFT = STARTER;AAPL/META/AMZN/GOOGL = WATCH;TSLA = WATCH+存量TRIM。看板 mega7_dashboard.html 已出`
...
|---|---|---|---|---|---|---|---|
| AAPL | ✅ | ✅ CLEAN | DECISION_DRAFT ~60% | WATCH | 0%/max 15% | WATCH | base 5y IRR +2.7%(<8%); binding=价格(~36x OE,起始 yield 2.7%); 耐久性 HIGH 但价格独立压到 WATCH |
| MSFT | ✅ | ✅ CLEAN | DECISION_DRAFT | STARTER | 3-5%/max~9% | STARTER | base 10y IRR +9.5%; 价格有正 MOS(FV~$436); binding=完整度(OpenAI/capex 缺口) |
| GOOGL | ✅刷新 | ✅ CLEAN | DECISION_DRAFT ~75% | WATCH | 0% | WATCH | 3日δ−1.4%无重大变化; binding=价格无MOS(base 10y IRR −3%); buy-below ~$113 |
| AMZN | ✅ | ✅ CLEAN | DECISION_DRAFT ~62% | WATCH | 0% | WATCH | base 5y IRR −1.5%; binding=价格无MOS+OE桥不闭合($200B capex拆分O4); GOOGL 型 |
| NVDA | ✅ | ✅ CLEAN | DECISION_DRAFT | STARTER | 3-5%/max~12% | STARTER | base 5y IRR +13%; 价格友好; binding=run-rate 可持续性 |
| META | ✅ | ✅ CLEAN | DECISION_DRAFT | WATCH | 0%/buy-below ~$480/max ~5% | STARTER(价格压到 WATCH) | base 5y IRR +4% (< 8% 门槛); binding=价格+capex ROI 未决(O4); 广告引擎满血但 owner earnings 被 capex 吃; 五灵魂一致 WATCH |
| TSLA | ✅ | ✅ CLEAN | DECISION_DRAFT ~55% | WATCH·存量TRIM | 0% | WATCH | base 5y IRR −17%; P/E 371x 叙事撑估值; 汽车利润池 16.8→4.6% 萎缩 + Musk key-man/12% 稀释; 唯一 TRIM |
